package ru.aydar.extensions;

import io.qameta.allure.Step;
import ru.aydar.models.LoginRequestModel;
import ru.aydar.models.LoginResponseModel;
...
import static ru.aydar.specs.BasicSpec.*;
...
public class LoginExtension implements BeforeEachCallback {
    ...
    public void beforeEach(ExtensionContext context) {
        ...
        authData.setUserName("aydarium");
        authData.setPassword("@Homework22");
